...
if __name__ == '__main__':
    ...
    r2h.save_harmonized_data(12.806510, 55.380277)
    i2db.insert_to_db()

    s2r.save_raw_data(17.818135, 66.051505)
    r2h.save_harmonized_data(17.818135, 66.051505)
    i2db.insert_to_db()

    s2r.save_raw_data(20.259427, 67.846472)
    r2h.save_harmonized_data(20.259427, 67.846472)
    i2db.insert_to_db()

    s2r.save_raw_data(23.403894, 67.192785)
    r2h.save_harmonized_data(23.403894, 67.192785)
    i2db.insert_to_db()

    s2r.save_raw_data(14.501744, 63.200153)
    r2h.save_harmonized_data(14.501744, 63.200153)
    i2db.insert_to_db()
